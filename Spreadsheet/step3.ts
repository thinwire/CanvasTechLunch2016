 ...
 * Step 3: Add scrolling
 * 
 * Spreadsheet draw loop has been split into smaller
 * methods to keep the code readable.
 * 
 * Rect, Scrollbar and Viewport classes are new additions,
 * they can be found in their respective source files.
 */
        ...
        switch(e.type) {
            case "mousedown":
                ...
                if(!this._vscrollbar.handleInput(e) && !this._hscrollbar.handleInput(e)) {
                    console.log("Should handle click");
                }
            break;
            case "mouseup":
                console.log("Capture mouse up");
            break;
            case "click":
                console.log("Captured mouse click");
            break;
        }
    }
